...
angular.module('coAppApp')
  .controller('ManagerInCtrl', function ($scope) {
    ...
    $scope.checklistIn = [
      ...
      { step: 11, action: 'LIMPIEZA DEP”SITO', info: 'Este debe estar totalmente ordenado, nada puede estar fuera de sus cajas o envase respectivo, ning˙n producto puede estar abierto. El ·rea debe estar totalmente limpia. <strong>NO PUEDE HABER NINGUN PRODUCTO EN EL PISO, TODO DEBE ESTAR SOBRE LOS ANAQUELES</strong>.'},
