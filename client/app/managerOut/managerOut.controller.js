...
angular.module('coAppApp')
  .controller('ManagerOutCtrl', function ($scope, $http, $cookieStore, Auth, Upload) {
    ...
    // // images upload
      ...
      // Form
    // $scope.newClose = function(closeForm) {
      ...
      // var picArray = [];
      // var pics = $('div[id='photo']');
      // angular.forEach(pics, function(i, files) {
      //   this.push(i.files);
      // }, picArray);
      ...
      // for loop to create incidence object
      // var output = {}
      // for (var i = 0; i < commentArray.length; i += 1) {
      //   if (commentArray[i] == '' && imgArray[i] == '') {
      //     console.log(commentArray[i] + 'vacio');
      //   } else {
      //     output[i] = {
      //       title: $scope.checklistOut[i].action,
